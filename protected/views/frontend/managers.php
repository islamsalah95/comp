<!-- <div id="content-container">
    <div class="pageheader">
        <h3><i><img src="<?php echo SITE_URL . '/uploads/logo/company_icons/icons_flex-06.png'; ?>" style ="width:40px;height:40px;margin:0 10px;"  alt="Managers Picture"></i><?php echo $lang['managers']; ?></h3>
        <div class="breadcrumb-wrapper">
            <span class="label"><?php echo $lang['you_are_here']; ?>:</span>
            <ol class="breadcrumb">
                <li class="active"><?php echo $lang['managers']; ?></li>
            </ol>
        </div>
    </div>
    ...
    <div id="page-content">
        <div class="panel-heading">
            <span class="pull-right">
                ...
                <a class="btn btn-primary" href="<?php echo $link->link('add_manager', frontend); ?>"><i class="fa fa-plus"></i> <?php echo $lang['add_manager']; ?></a>
            </span>
        </div>
...
<!-- <?php echo SITE_URL . "/index.php?user=get_managers"  ?> -->
<!-- <script type="text/javascript">
    $(document).ready(function() {
        // var url = '<?php echo SITE_URL . "/index.php?user=get_managers"?>';
       var url = '<?php echo $link->link("get_managers", frontend); ?>';
                        ...
                        foreach ($freelancers as $freelancer) { ?>
                            <tr>
                                ...
                                <td style="display: flex; justify-content: flex-start;align-items: center;">
                                    ...
                                    <form method="post" action="<?= $link->link("edit_manager", frontend) ?>">
