                        ...
                        <div class="tab-base">
                            ...
                            <div class="tab-content" style="padding: 0;">
                                <div id="tab1" class="tab-pane fade  <?php if ($current_tab == 'tab1'  || $current_tab == '') {
                                    ...
                                    <form method="post" action="<?php $link->link("edit_freelancer", frontend); ?>" enctype="multipart/form-data" id="editPersonalInfo">
                                ...
                                <?php if ($_SESSION['department'] == 1 || $_SESSION['department'] == 5) { ?>
                                    <div id="tab2" class="tab-pane fade <?php if ($current_tab == 'tab2') {
                                        ...
                                        <form method="post" action="<?php $link->link("edit_freelancer"); ?>" enctype="multipart/form-data" id="editLoginInfo">
