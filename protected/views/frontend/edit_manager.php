<div id="content-container">
    <div class="pageheader">
        <h3><i></i><?php echo $lang['edit_manager']; ?></h3>
        <div class="breadcrumb-wrapper">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo $lang['edit_manager']; ?></li>
            </ol>
        </div>
    </div>
    <div id="page-content">
                        ...
                        <div class="tab-base">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab1" class="tab-pane fade  <?php if ($current_tab == 'tab1'  || $current_tab == '') {
                                    ...
                                    <form method="post" action="<?= $link->link("edit_manager", 'frontend') ?>" enctype="multipart/form-data" id="editPersonalInfo">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="form-group">
                                                        <div class="text-left">
                                                            ...
                                                            <input class="form-control" type="text" placeholder="Enter your name *" name="emp_name" value="<?php echo $get_row['emp_name']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="text-left">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="text-left">
                                                            ...
                                                            <select class="form-control" name="company[]" id="user_company" data-placeholder=" " multiple>
                                                                <?php
                                                                // Check if $get_row['company'] is an array to prevent errors
                                                                $selectedCompanies = is_array($get_row['company']) ? $get_row['company'] : [];

                                                                if (is_array($company)) {
                                                                    foreach ($company as $value) {
                                                                        $selected = in_array($value['id'], $selectedCompanies) ? 'selected' : '';
                                ...
                                <?php if ($_SESSION['department'] == 1 || $_SESSION['department'] == 5) { ?>
                                    <div id="tab2" class="tab-pane fade <?php if ($current_tab == 'tab2') {
                                        ...
                                        <form method="post" action="<?php $link->link("edit_manager", frontend); ?>" enctype="multipart/form-data" id="editLoginInfo">
                                ...
                                <div id="tab3" class="tab-pane fade <?php if ($current_tab == 'tab3') {
                                    ...
                                    <form method="post" action="<?php $link->link("edit_manager", frontend); ?>" enctype="multipart/form-data" id="editProfileImage">
