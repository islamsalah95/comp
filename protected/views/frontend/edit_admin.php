<div id="content-container">
   <div class="pageheader">
      <h3><i></i><?php echo $lang['edit_admin']; ?></h3>
      <div class="breadcrumb-wrapper">
         <span class="label"><?php echo $lang['you_are_here']; ?>:</span>
         <ol class="breadcrumb">
            <li> <a href="<?php echo $link->link('home', frontend); ?>"> <?php echo $lang['dashboard']; ?> </a> </li>
            <li> <a href="<?php echo $link->link('admin', frontend); ?>"><?php echo $lang['view_admin']; ?> </a> </li>
            <li class="active"><?php echo $lang['edit_admin']; ?></li>
         </ol>
      </div>
   </div>
   <div id="page-content">
                  ...
                  <div class="tab-base">
                     ...
                     <div class="tab-content">
                        <div id="tab1" class="tab-pane fade  <?php if ($current_tab == 'tab1'  || $current_tab == '') {
                           ...
                           <!-- <form method="post" action="<?php $link->link("edit_admin", frontend, '&edit=' . $load . '&tab=' . $current_tab); ?>" enctype="multipart/form-data" id="editPersonalInfo"> -->
                           <form method="post" action="<?php $link->link("edit_admin", frontend); ?>" enctype="multipart/form-data" id="editPersonalInfo">
                                    ...
                                    <div class="col-sm-7">
                                       ...
                                       <?php if ($_SESSION['department'] == 1 || $_SESSION['department'] == 5) { ?>
                                          ...
                                          <select class="form-control " name="department">
                                             <option value="2" <?php if ($get_row['department'] == 2) echo "selected"; ?> >User</option>
                                             <option value="4" <?php if ($get_row['department'] == 4) echo "selected"; ?> >Manager</option>
                                          </select>
                                       </div> -->
                                       <?php } ?>
                        ...
                        <div id="tab2" class="tab-pane fade <?php if ($current_tab == 'tab2') {
                           ...
                           <form method="post" action="<?php $link->link("edit_admin", frontend); ?>" enctype="multipart/form-data" id="editLoginInfo">
                           <input type="hidden" name="edit" value="<?= $load ?>">
                        ...
                        <div id="tab3" class="tab-pane fade <?php if ($current_tab == 'tab3') {
                           ...
                           <form method="post" action="<?php $link->link("edit_admin", frontend); ?>" enctype="multipart/form-data" id="editProfileImage">
