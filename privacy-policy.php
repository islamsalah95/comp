...
<head>
    <title>Techsupflex | Privacy Policy</title>
    <link href="https://techsupflex.com/uploads/logo/company_icons/background_techsup_flex-02.png" rel="shortcut icon" type="image/x-icon">
    <link href="https://fonts.googleapis.com/css?family=Roboto+Slab:300,400,700|Roboto:300,400,700" rel="stylesheet">
    <link href="https://techsuptrack.com/assets/frontend/css/bootstrap.min.css" rel="stylesheet">
</head>

<body>
    <header class="text-center">
        <a class="text-center" href="https://www.techsupflex.co/"><img src="https://techsupflex.com/assets/main_frontend/images/logo-1-removebg-preview-294x122.png" width="200px" alt="Techsuptrack" /></a>
    </header>
    <div class="container">
        <h1>Privacy Policy</h1>
        <p>At Techsupflex, accessible from Techsupflex.com, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is
            collected and recorded by Techsupflex and how we use it.</p>
        <p></p>If you have additional questions or require more information about our Privacy Policy,
        do not hesitate to <a class="link" target="_blank" href="https://www.techsupflex.co/">contact us</a></p>
        <h3>Log Files</h3>
        <p>Techsupflex follows a standard procedure of using log files. These files log visitors when
        ...
        <p>Like any other website, Techsupflex uses "cookies". These cookies are used to store
        ...
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
            ...
            Techsupflex, which are sent directly to users' browser. They automatically receive your IP
        ...
        <p>Note that Techsupflex has no access to or control over these cookies that are used by
            third-party advertiser
        </p>
        <h3>Third Party Privacy Policies
        </h3>
        <p>Techsupflex's Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>Techsupflex does not knowingly collect any Personal Identifiable Information from
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
            website with regards to the information that they shared and/or collect in Techsupflex.
